@extends('petugas.includes.layout')
    ...
    @foreach ($pengaduan as $laporan)
        <div id="modal-verif-{{ $laporan->id_pengaduan }}" 
            ...
            <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
                ...
                <form action="{{ route('petugas.verifikasi.update', $laporan->id_pengaduan) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
    ...
    @foreach ($pengaduan as $laporan)
        <div id="modal-tanggapan-{{ $laporan->id_pengaduan }}" 
            ...
            <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
                ...
                <form action="{{ route('petugas.tanggapan.update', $laporan->id_pengaduan) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
